...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textSize.width + 10, textSize.height + 10)];
...
+ (void)showWithText:(NSString *)text_{
    [SHToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    SHToast *toast = [[SHToast alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [SHToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [SHToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
