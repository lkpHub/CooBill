...
- (void)viewDidLoad {
    ...
    self.view.unTouchRect = CGRectMake(0, 0, self.view.frame.size.width, 64);
...
- (UIView *)bgView {
    if (!_bgView) {
        ...
        _bgView.frame = CGRectMake(0, CGRectGetMaxY(self.searchBar.frame) + 64, KPWidth, KPHeight - self.searchBar.frame.size.height);
